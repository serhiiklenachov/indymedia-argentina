...
include get_stylesheet_directory() . '/inc/social.php';
...
if ( !function_exists( 'indymedia_theme_setup' ) ) {
	function indymedia_theme_setup() {
		...
		wp_enqueue_style( 'font-awesome', get_stylesheet_directory_uri() . '/vendor/font-awesome/css/font-awesome.min.css', array(), '4.7.0' );
		...
		wp_enqueue_style( 'indymedia-style', get_stylesheet_directory_uri() . '/style.css', 'parent-style', '1.1.0' );
